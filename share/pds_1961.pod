...
pds_1961.db - size M database with planar difference set samples
...
It contains 1961 cyclic planar difference set planes with orders
ranging from 2 to 16384.  For all planes, std reference sets are included.
